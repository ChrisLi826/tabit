...
| `+ Note` | GtkSourceView editor; tools bar at bottom: Base64 / JSON (with shortcuts); wrap default on (toggle in **Settings…**); huge/long-line auto-disable syntax highlight |
...
| `Ctrl+Alt+J` / `Ctrl+Alt+K` | Note JSON format / validate |
